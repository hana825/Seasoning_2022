...
public class FootBallController {
	...
	public String seoul(Model model) {
		...
		model.addAttribute("LAYOUT", "FB-SEOUL");
	...
	public String daegu(Model model) {
		...
		model.addAttribute("FOOTBALL", fblist);
		model.addAttribute("LAYOUT", "FB-DAEGU");
	...
	public String gangwon1(Model model) {
		...
		model.addAttribute("FOOTBALL", fblist);
		model.addAttribute("LAYOUT", "FB-GANGWON1");
	...
	public String gangwon2(Model model) {
		...
		model.addAttribute("FOOTBALL", fblist);
		model.addAttribute("LAYOUT", "FB-GANGWON2");
	...
	public String gimcheon(Model model) {
		...
		model.addAttribute("FOOTBALL", fblist);
		model.addAttribute("LAYOUT", "FB-GIMCHEON");
	...
	public String incheon(Model model) {
		...
		model.addAttribute("FOOTBALL", fblist);
		model.addAttribute("LAYOUT", "FB-INCHEON");
	...
	public String jeju(Model model) {
		...
		model.addAttribute("FOOTBALL", fblist);
		model.addAttribute("LAYOUT", "FB-JEJU");
	...
	public String jeonbuk(Model model) {
		...
		model.addAttribute("FOOTBALL", fblist);
		model.addAttribute("LAYOUT", "FB-JEONBUK");
	...
	public String pohang(Model model) {
		...
		model.addAttribute("FOOTBALL", fblist);
		model.addAttribute("LAYOUT", "FB-POHANG");
	...
	public String seongnam(Model model) {
		...
		model.addAttribute("FOOTBALL", fblist);
		model.addAttribute("LAYOUT", "FB-SEONGNAM");
	...
	public String suwon_ss(Model model) {
		...
		model.addAttribute("FOOTBALL", fblist);
		model.addAttribute("LAYOUT", "FB-SUWON-SS");
	...
	public String suwon(Model model) {
		...
		model.addAttribute("FOOTBALL", fblist);
		model.addAttribute("LAYOUT", "FB-SUWON");
	...
	public String ulsan(Model model) {
		...
		model.addAttribute("FOOTBALL", fblist);
		model.addAttribute("LAYOUT", "FB-ULSAN");
