...
<title>Season + ing ㅣ baseball-kiwoom</title>
...
<body>
	...
	<section>
		<article>
			...
			<div id="kbo-box">
				...
				<div id="ticket-book">
					...
					<div style="display: none;">
						<p id="st_x">37.498333</p>
						<p id="st_y">126.866667</p>
					</div>
	        ...
	        <a href="${rootPath}/baseball/bb-kiwoom"><div class="map-point kiwoom" style="font-size: 18px; background-color: rgb(0, 24, 65);">키움 히어로즈</div></a>
				...
				<div id="menu_wrap" class="bg_white">
					<div class="around-tour-button">
						<form onsubmit="searchPlaces1(); return false;">
							<button id="keyword1" type="submit" value="고척스카이돔 맛집">식당</button>
						</form>
						<form onsubmit="searchPlaces2(); return false;">
							<button type="submit" value="고척스카이돔 숙박" id="keyword2">숙박</button>
						</form>
					</div>
					<hr>
					<ul id="placesList"></ul>
