...
<body>
	...
	<section>
		<article>
	        ...
	        <a href="${rootPath}/baseball/bb-kt"><div class="map-point kt" style="font-size: 18px; background-color: rgb(0, 24, 65);">KT 위즈</div></a>
				...
				<div id="menu_wrap" class="bg_white">
					<div class="around-tour-button">
						<form onsubmit="searchPlaces1(); return false;">
							<button id="keyword1" type="submit" value="수원케이티위즈파크 맛집">식당</button>
						</form>
						<form onsubmit="searchPlaces2(); return false;">
							<button type="submit" value="수원케이티위즈파크 숙박" id="keyword2">숙박</button>
						</form>
					</div>
					<hr>
					<ul id="placesList"></ul>
