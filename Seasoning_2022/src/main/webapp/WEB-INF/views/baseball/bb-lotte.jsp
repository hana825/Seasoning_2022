...
<title>Season + ing ㅣ baseball-lotte</title>
...
<body>
	...
	<section>
		<article>
			...
			<div id="kbo-box">
				...
				<div id="ticket-book">
					...
					<div style="display: none;">
						<p id="st_x">35.194077</p>
						<p id="st_y">129.061584</p>
					</div>
	        ...
	        <a href="${rootPath}/baseball/bb-lotte"><div class="map-point lotte" style="font-size: 18px; background-color: rgb(0, 24, 65);">롯데 자이언츠</div></a>
				...
				<div id="menu_wrap" class="bg_white">
					<div class="around-tour-button">
						<form onsubmit="searchPlaces1(); return false;">
							<button id="keyword1" type="submit" value="사직 야구장 맛집">식당</button>
						</form>
						<form onsubmit="searchPlaces2(); return false;">
							<button type="submit" value="사직 야구장 숙박" id="keyword2">숙박</button>
						</form>
					</div>
					<hr>
					<ul id="placesList"></ul>
