...
<link rel="stylesheet" href="${rootPath}/static/css/kbo-box.css?ver=2022-06-14-007" />
...
<body>
	...
	<section>
		<article>
			...
			<a href="${rootPath}/baseball/bb-dusan"><div class="map-point dusan" style="font-size: 14px; background-color: rgb(0, 24, 65);">두산 베어스</div></a>
