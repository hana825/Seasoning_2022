...
<title>Season + ing ㅣ baseball-hanwha</title>
...
<body>
	...
	<section>
		<article>
			...
			<div id="kbo-box">
				...
				<div id="ticket-book">
					...
					<div style="display: none;">
						<p id="st_x">36.317085</p>
						<p id="st_y">127.429131</p>
					</div>
	        ...
	        <a href="${rootPath}/baseball/bb-hanwha"><div class="map-point hanwha" style="font-size: 18px; background-color: rgb(0, 24, 65);">한화 이글스</div></a>
				...
				<div id="menu_wrap" class="bg_white">
					<div class="around-tour-button">
						<form onsubmit="searchPlaces1(); return false;">
							<button id="keyword1" type="submit" value="한화생명이글스파크 맛집">식당</button>
						</form>
						<form onsubmit="searchPlaces2(); return false;">
							<button type="submit" value="한화생명이글스파크 숙박" id="keyword2">숙박</button>
						</form>
					</div>
					<hr>
					<ul id="placesList"></ul>
