...
<title>Season + ing ㅣ baseball-kia</title>
...
<body>
	...
	<section>
		<article>
			...
			<div id="kbo-box">
				...
				<div id="ticket-book">
					...
					<div style="display: none;">
						<p id="st_x">35.168339</p>
						<p id="st_y">126.888992</p>
					</div>
	        ...
	        <a href="${rootPath}/baseball/bb-kia"><div class="map-point kia" style="font-size: 18px; background-color: rgb(0, 24, 65);">kia 타이거즈</div></a>
				...
				<div id="menu_wrap" class="bg_white">
					<div class="around-tour-button">
						<form onsubmit="searchPlaces1(); return false;">
							<button id="keyword1" type="submit" value="기아챔피언스필드 맛집">식당</button>
						</form>
						<form onsubmit="searchPlaces2(); return false;">
							<button type="submit" value="기아챔피언스필드 숙박" id="keyword2">숙박</button>
						</form>
					</div>
					<hr>
					<ul id="placesList"></ul>
