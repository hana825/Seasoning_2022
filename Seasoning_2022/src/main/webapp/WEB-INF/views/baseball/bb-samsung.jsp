...
<title>Season + ing ㅣ baseball-samsung</title>
...
<body>
	...
	<section>
		<article>
			...
			<div id="kbo-box">
				...
				<div id="ticket-book">
					...
					<div style="display: none;">
						<p id="st_x">35.841064</p>
						<p id="st_y">128.681641</p>
					</div>
	        ...
	        <a href="${rootPath}/baseball/bb-samsung"><div class="map-point samsung" style="font-size: 18px; background-color: rgb(0, 24, 65);">삼성 라이온즈</div></a>
				...
				<div id="menu_wrap" class="bg_white">
					<div class="around-tour-button">
						<form onsubmit="searchPlaces1(); return false;">
							<button id="keyword1" type="submit" value="대구 수성구 야구전설로 1 맛집">식당</button>
						</form>
						<form onsubmit="searchPlaces2(); return false;">
							<button type="submit" value="대구 수성구 야구전설로 1 숙박" id="keyword2">숙박</button>
						</form>
					</div>
					<hr>
					<ul id="placesList"></ul>
...
<script src="${rootPath}/static/js/btn.js?var=2022-06-16-001"></script>
<script src="${rootPath}/static/js/bb_popular_button.js?ver=2022-06-16-028"></script>
</html>
