...
<title>Season + ing ㅣ fb-daegu</title>
	...
	<section>
		<article>
			...
			<div id="k-league-box">
				...
				<div id="ticket-book">
					<div style="display: none;">
						<p id="st_x">35.881253</p>
						<p id="st_y">128.588231</p>
					</div>
			...
			<a><div class="map-point seoul">FC 서울</div></a> <a><div
					...
					class="map-point deagu"
					style="font-size: 18px; background-color: rgb(0, 24, 65);">대구
					FC</div></a> <a><div class="map-point seongnam">성남 FC</div></a> <a><div
