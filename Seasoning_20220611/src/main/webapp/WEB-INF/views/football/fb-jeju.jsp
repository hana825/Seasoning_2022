...
<title>Season + ing ㅣ fb-jeju</title>
	...
	<section>
		<article>
			...
			<div id="k-league-box">
				...
				<div id="ticket-book">
					<div style="display: none;">
						<p id="st_x">33.246212</p>
						<p id="st_y">126.509361</p>
					</div>
			...
			<a><div class="map-point seoul">FC 서울</div></a> <a><div
					...
					class="map-point jeju"
					style="font-size: 18px; background-color: rgb(0, 24, 65);">제주
					UNT</div></a> <a><div class="map-point pohang">포항 스틸러스</div></a>
		</article>
		<article>
