...
<title>Season + ing ㅣ fb-gimcheon</title>
...
<body>
		...
		<nav id="nav-menu">
			...
			<div id="drop">
				<ul id="menu">
					...
					<li id="baseball"><a href="${rootPath}/baseball/bb-dusan">야구</a>
	...
	<section>
		<article>
			...
			<div id="k-league-box">
				...
				<div id="ticket-book">
					<div style="display: none;">
						<p id="st_x">36.139666</p>
						<p id="st_y">128.086509</p>
					</div>
			...
			<a><div class="map-point seoul">FC 서울</div></a> <a><div
					class="map-point gangwon1">강원 FC</div></a> <a><div
					class="map-point gangwon2">강원 FC</div></a> <a><div
					class="map-point gimcheon"
					style="font-size: 18px; background-color: rgb(0, 24, 65);">김천
					상무</div></a> <a><div class="map-point deagu">대구 FC</div></a> <a><div
